...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-center gap-2 px-6 py-5.5 lg:py-6.5 mb-[-60px]">
        <Link href="/">
          {/* <Image
            width={176}
            height={32}
            ...
            priority
          /> */}
          <p><span className="from-neutral-700 text-pretty font-normal text-meta-10 from-stone-300 text-5xl">R</span>eejan</p>
        </Link>
